...
export const MESSAGE_OPEN_EDIT= 'open-edit'
...
export const GENERATE_TYPE_SUMMARY = 'summary'
...
export const CONTEXT_MEUNITEM_ID_SEARCH_NPM_TREND = 'search_npm_trend'
export const CONTEXT_MEUNITEM_ID_SEARCH_MDN = 'search_mdn'
export const CONTEXT_MEUNITEM_ID_READ_SOURCE = 'read_source'
export const CONTEXT_MEUNITEM_ID_SEARCH_GIT_PRO = 'search_git_pro'
export const CONTEXT_MEUNITEM_ID_GPT = 'search_gpt'